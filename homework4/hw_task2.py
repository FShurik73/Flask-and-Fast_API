...
def pr_sum_array(arr, sum_):
    with sum_.get_lock():
        sum_.value += sum(arr)


def processes_sum_array(arr, proc_count):
    summa = Value('i', 0)
    processes = [Process(target=pr_sum_array, args=(arr[i::proc_count], summa))
...
if __name__ == '__main__':
    ...
    num_processes = 4
    summa = processes_sum_array(arr, num_processes)
    print(summa)
